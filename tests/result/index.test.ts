...
describe("Result.gen", () => {
    ...
    test("should handle async generators returning non-Result value", async () => {
    ...
    test("should handle async generators returning Result value", async () => {
        const ok = Ok(2);
        const value = await Result.gen(async function* () {
            return ok;
        });
...
describe("Result.try", () => {
    ...
    test("should return Ok if the async function executes successfully", async () => {
    ...
    test("should return Err if the async function throws", async () => {
        const result = await Result.try(async () => {
            throw "Test error";
        });
        expectTypeOf(result).toEqualTypeOf<Result<never, unknown>>();
    ...
    test("should return Err with Error instance if the async function throws", async () => {
        const result = await Result.try(async () => {
            throw "Test error";
        }, Error);
        expectTypeOf(result).toEqualTypeOf<Result<never, Error>>();
    ...
    test("should return Err with the specified error type if the async function throws", async () => {
