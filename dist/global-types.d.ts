import * as Types from "@goodbyenjn/utils/types";

//#region src/types/global-types.d.ts
...
declare global {
  ...
  type AsyncFnWithThis<Return = any, Args extends readonly any[] = any[], This = unknown> = Types.AsyncFnWithThis<Return, Args, This>;
  type Fn<Return = any, Args extends readonly any[] = any[]> = Types.Fn<Return, Args>;
  type FnWithThis<Return = any, Args extends readonly any[] = any[], This = unknown> = Types.FnWithThis<Return, Args, This>;
  type SyncFn<Return = any, Args extends readonly any[] = any[]> = Types.SyncFn<Return, Args>;
  type SyncFnWithThis<Return = any, Args extends readonly any[] = any[], This = unknown> = Types.SyncFnWithThis<Return, Args, This>;
  type Entries<BaseType> = Types.Entries<BaseType>;
  type Entry<BaseType> = Types.Entry<BaseType>;
  type LiteralUnion<LiteralType, BaseType extends Primitive> = Types.LiteralUnion<LiteralType, BaseType>;
  type OmitByKey<ObjectType, KeysType extends keyof ObjectType> = Types.OmitByKey<ObjectType, KeysType>;
  ...
  type YieldType<TargetGeneratorFn extends Fn<Generator | AsyncGenerator>> = Types.YieldType<TargetGeneratorFn>;
