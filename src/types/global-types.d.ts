...
declare global {
    class ObjectConstructor {
         ...
         *
         * @param entries An iterable object that contains key-value entries for properties and
         *   methods.
         */
...
interface MapWithExistsKey<K, V, ExistsKey extends K> extends Map<K, V> {
     ...
     * provided key is an object, then you will get a reference to that object and any change made
     * to that object will effectively modify it inside the Map.
     *
...
declare global {
    ...
    interface ReadonlyArray<T> {
         ...
         * @param searchElement The value to locate in the array.
         * @param fromIndex The array index at which to begin the search. If fromIndex is omitted,
         *   the search starts at the last index in the array.
         */
        lastIndexOf(searchElement: T | (WidenLiteral<T> & {}), fromIndex?: number): number;
    }
}
